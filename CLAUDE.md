...
- 002-first-full-run: Added TypeScript 5.x (Electron app), Python 3.11+ (agent-orchestrator) + Electron 30, React 18, FastAPI, uvicorn, nats-py 2.9, claude-agent-sdk 0.1.52+
