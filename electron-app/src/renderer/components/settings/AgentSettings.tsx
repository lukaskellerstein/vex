...
export function AgentSettings() {
  ...
  useEffect(() => {
    window.electronAPI.getConfig().then((data: Record<string, unknown>) => {
      ...
      if (typeof data.auto_restart_on_error === "boolean")
        setAutoRestart(data.auto_restart_on_error);
  ...
  return (
    <div>
      ...
      <FieldRow
        ...
        description="The agent type assigned to new agents when not specified."
      >
      ...
      <FieldRow
        ...
        description="Automatically restart an agent if it encounters a fatal error."
      >
      ...
      <FieldRow
        label="Restart delay"
        description="Wait time in seconds before automatically restarting a failed agent."
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <input
            type="number"
      ...
      <FieldRow
        ...
        description="Mark an agent as offline after this many seconds without a heartbeat."
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <input
            type="number"
