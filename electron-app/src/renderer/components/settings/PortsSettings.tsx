...
export function PortsSettings() {
  ...
  return (
    <div>
      ...
      >
        Configure the network ports Vex uses for internal service communication. Changes require a
        restart.
      </p>

      <FieldRow
        label="NATS port"
        description="Port for the NATS message bus used by agents and the event system."
      >
        <input
          type="number"
          value={natsPort}
      ...
      <FieldRow
        ...
        description="Port for the WebSocket server used by the browser extension."
      >
        <input
          type="number"
          value={wsPort}
      ...
      <FieldRow
        label="Agent Manager port"
        description="Port for the internal Agent Manager HTTP API."
      >
        <input
          type="number"
          value={aoPort}
          ...
          <div style={{ marginTop: "8px", display: "flex", flexDirection: "column", gap: "4px" }}>
            {[
              ...
              >
                ...
                <span
                  style={{
                    color: status === "clear" ? "var(--status-success)" : "var(--status-error)",
                  }}
                >
