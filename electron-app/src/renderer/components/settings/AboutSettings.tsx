...
export function AboutSettings() {
  ...
  useEffect(() => {
    window.electronAPI.getAppInfo().then((info: Record<string, string>) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <div style={{ fontSize: '13px', color: 'var(--foreground-dim)', marginTop: '6px', textAlign: 'center' }}>
      ...
      <LinkRow icon={FileText} label="Documentation" url="https://github.com/lukaskellerstein/vex#readme" />
      <LinkRow icon={GitBranch} label="GitHub Repository" url="https://github.com/lukaskellerstein/vex" />
      <LinkRow icon={MessageSquare} label="Report an Issue" url="https://github.com/lukaskellerstein/vex/issues/new" />
      ...
      <div style={{ marginTop: '24px' }}>
        <button
          ...
          style={{
            ...
            fontSize: '13px',
            fontWeight: 600,
            color: updateStatus === 'up-to-date' ? 'var(--status-success)' : 'var(--foreground-muted)',
          ...
          onMouseLeave={(e) => {
            ...
            e.currentTarget.style.color = updateStatus === 'up-to-date'
              ? 'var(--status-success)'
        ...
        >
          {updateStatus === 'checking' ? (
            ...
            <>
              <CheckCircle2 size={14} strokeWidth={1.5} style={{ color: 'var(--status-success)' }} />
              Up to date
            </>
          ) : (
            <>
